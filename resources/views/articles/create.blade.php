                ...
                <div class="p-6 text-gray-900">
                    <form action="{{ route('articles.store') }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="keywords" value="{{ old('keywords') }}" placeholder="laravel, php, backend..." class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="content" rows="8" required class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">{{ old('content') }}</textarea>
                        ...
                        <div class="flex justify-end space-x-3">
                            ...
                            <button type="submit" class="px-4 py-2 bg-indigo-600 text-white rounded-md text-sm font-medium hover:bg-indigo-700">Kaydet</button>
                        </div>
                    </form>
                </div>
            </div>
